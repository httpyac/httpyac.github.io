import{r as e,o as p,c as t,a as n,b as r,F as o,e as s,d as l}from"./app.418c62b6.js";import{_ as c}from"./plugin-vue_export-helper.21dcd24c.js";const u={},i=n("h1",{id:"examples",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#examples","aria-hidden":"true"},"#"),s(" Examples")],-1),b=s("Here is just a short list of possible use cases. The source code can be found directly in the "),m={href:"https://github.com/httpyac/httpyac.github.io/tree/main/examples",target:"_blank",rel:"noopener noreferrer"},k=s("Github repository"),d=l(`<h2 id="arbeitsagentur-jobborse" tabindex="-1"><a class="header-anchor" href="#arbeitsagentur-jobborse" aria-hidden="true">#</a> Arbeitsagentur Jobb\xF6rse</h2><div class="language-http ext-http line-numbers-mode"><pre class="language-http"><code>@job_clientId=c003a37f-024f-462a-b36d-b001be4cd24a
...
<span class="token header-name keyword">Authorization:</span> Bearer {{session.token}}
...
<span class="token header-name keyword">Authorization:</span> Bearer {{git_api_key}}<span class="token application-json">
