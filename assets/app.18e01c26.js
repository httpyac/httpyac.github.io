...
} : isObject(val) && !isArray(val) && !isPlainObject(val) ? String(val) : val;
...
function resolveMergedOptions(instance) {
  ...
  ), mergeOptions(resolved, base, optionMergeStrategies)), isObject(base) && cache.set(base, resolved), resolved;
}
...
function createAppAPI(render, hydrate) {
  return function(rootComponent, rootProps = null) {
    isFunction(rootComponent) || (rootComponent = extend({}, rootComponent)), rootProps != null && !isObject(rootProps) && (rootProps = null);
...
const InternalObjectKey = "__vInternal", normalizeKey = ({ key }) => key ?? null, normalizeRef = ({
  ...
  ref_key,
  ref_for
}) => (typeof ref2 == "number" && (ref2 = "" + ref2), ref2 != null ? isString$1(ref2) || isRef(ref2) || isFunction(ref2) ? { i: currentRenderingInstance, r: ref2, k: ref_key, f: !!ref_for } : ref2 : null);
...
function useSupported(callback, sync = !1) {
  const isSupported = ref(), update = () => isSupported.value = !!callback();
...
const VPSkipLink = /* @__PURE__ */ _export_sfc(_sfc_main$11, [["__scopeId", "data-v-151f2593"]]), _hoisted_1$Q = {
  ...
  setup(__props) {
    return (_ctx, _cache) => (openBlock(), createBlock(Transition, { name: "fade" }, {
      default: withCtx(() => [
        _ctx.show ? (openBlock(), createElementBlock("div", _hoisted_1$Q)) : createCommentVNode("", !0)
      ]),
      _: 1
    }));
  }
...
const _hoisted_1$N = { class: "VPNavBarSearch" }, _hoisted_2$A = { class: "DocSearch-Form" }, _hoisted_3$r = /* @__PURE__ */ createBaseVNode("label", {
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      var _a2, _b;
      const data = await __vitePreload(() => import("./chunks/virtual_search-data.f23114c3.js"), []);
...
const VPMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$T, [["__scopeId", "data-v-88f937c6"]]), _hoisted_1$I = { class: "VPMenuGroup" }, _hoisted_2$w = {
  ...
  setup(__props) {
    return (_ctx, _cache) => (openBlock(), createElementBlock("div", _hoisted_1$I, [
      _ctx.text ? (openBlock(), createElementBlock("p", _hoisted_2$w, toDisplayString(_ctx.text), 1)) : createCommentVNode("", !0),
...
const VPMenuGroup = /* @__PURE__ */ _export_sfc(_sfc_main$S, [["__scopeId", "data-v-b66affaf"]]), _hoisted_1$H = { class: "VPMenu" }, _hoisted_2$v = {
  ...
  setup(__props) {
    return (_ctx, _cache) => (openBlock(), createElementBlock("div", _hoisted_1$H, [
      _ctx.items ? (openBlock(), createElementBlock("div", _hoisted_2$v, [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => (openBlock(), createElementBlock("div", {
      ...
      createBaseVNode("button", {
        ...
        _ctx.button || _ctx.icon ? (openBlock(), createElementBlock("span", _hoisted_2$u, [
...
const VPSocialLink = /* @__PURE__ */ _export_sfc(_sfc_main$G, [["__scopeId", "data-v-e57698f6"]]), _hoisted_1$x = { class: "VPSocialLinks" }, _sfc_main$F = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => (openBlock(), createElementBlock("div", _hoisted_1$x, [
      (openBlock(!0), createElementBlock(Fragment, null, renderList(_ctx.links, ({ link: link2, icon }) => (openBlock(), createBlock(VPSocialLink, {
        key: link2,
        icon,
        link: link2
...
const VPNavScreenMenuGroupLink = /* @__PURE__ */ _export_sfc(_sfc_main$y, [["__scopeId", "data-v-3d20956d"]]), _hoisted_1$s = { class: "VPNavScreenMenuGroupSection" }, _hoisted_2$j = {
  ...
  setup(__props) {
    return (_ctx, _cache) => (openBlock(), createElementBlock("div", _hoisted_1$s, [
      _ctx.text ? (openBlock(), createElementBlock("p", _hoisted_2$j, toDisplayString(_ctx.text), 1)) : createCommentVNode("", !0),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => (openBlock(), createElementBlock("div", {
      ...
      createBaseVNode("button", {
        ...
        createBaseVNode("span", _hoisted_2$i, toDisplayString(_ctx.text), 1),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(resolveDynamicComponent(sectionTag.value), {
        ...
        default: withCtx(() => [
          _ctx.item.text ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: "item",
            role: itemRole.value,
            onClick: onItemClick
          ...
          _ctx.item.items && _ctx.item.items.length ? (openBlock(), createElementBlock("div", _hoisted_3$b, [
    ...
    return (_ctx, _cache) => (openBlock(), createElementBlock("div", {
      ...
      createBaseVNode("div", _hoisted_1$f, [
        createBaseVNode("div", _hoisted_2$b, [
          ...
          _ctx.text ? (openBlock(), createElementBlock("p", _hoisted_5$4, toDisplayString(_ctx.text), 1)) : createCommentVNode("", !0),
          _ctx.tagline ? (openBlock(), createElementBlock("p", _hoisted_6$4, toDisplayString(_ctx.tagline), 1)) : createCommentVNode("", !0),
    ...
    return (_ctx, _cache) => (openBlock(), createBlock(VPLink, {
      ...
      default: withCtx(() => [
        createBaseVNode("article", _hoisted_1$d, [
          ...
          }, null, 8, ["image", "alt", "height", "width"])) : _ctx.icon ? (openBlock(), createElementBlock("div", _hoisted_2$9, toDisplayString(_ctx.icon), 1)) : createCommentVNode("", !0),
          createBaseVNode("h2", {
            class: "title",
...
const VPFeature = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-a5828f43"]]), _hoisted_1$c = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => _ctx.features ? (openBlock(), createElementBlock("div", _hoisted_1$c, [
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("ul", {
        ...
        (openBlock(!0), createElementBlock(Fragment, null, renderList(_ctx.headers, ({ children, link: link2, title }) => (openBlock(), createElementBlock("li", null, [
          createBaseVNode("a", {
            class: "outline-link",
            href: link2,
...
const VPDocAsideOutlineItem = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-1188541a"]]), _withScopeId$3 = (n) => (pushScopeId("data-v-5dd9d5f6"), n = n(), popScopeId(), n), _hoisted_1$9 = { class: "content" }, _hoisted_2$7 = { class: "outline-title" }, _hoisted_3$5 = { "aria-labelledby": "doc-outline-aria-label" }, _hoisted_4$4 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ createBaseVNode("span", {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => (openBlock(), createElementBlock("div", {
      class: normalizeClass(["VPDocAsideOutline", { "has-outline": hasOutline.value }]),
      ref_key: "container",
      ref: container
    }, [
...
const VPIconEdit = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render]]), _hoisted_1$5 = { class: "VPLastUpdated" }, _hoisted_2$4 = ["datetime"], _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return onMounted(() => {
      ...
      createBaseVNode("time", { datetime: isoDatetime.value }, toDisplayString(datetime.value), 9, _hoisted_2$4)
    ]));
  }
});
const VPDocFooterLastUpdated = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-355aa5ef"]]), _hoisted_1$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      var _a2, _b, _c, _d, _e, _f, _g;
      return showFooter.value ? (openBlock(), createElementBlock("footer", _hoisted_1$4, [
        hasEditLink.value || hasLastUpdated.value ? (openBlock(), createElementBlock("div", _hoisted_2$3, [
