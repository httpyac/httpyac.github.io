...
</code></pre><div class="highlight-lines"><div class="highlight-line">\xA0</div><br></div><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>All received messages are output as an intermediate result and summarized at the end as one overall response. If the intermediate results are not needed, they can be deactivated using <code># @noStreamingLog</code>.</p></div>`,4),fn={class:"custom-container tip"},yn=n("p",{class:"custom-container-title"},"TIP",-1),qn=s("If special options are needed for initialization, they can be configured in a NodeJS script using "),wn={href:"https://github.com/AnWeber/httpyac/blob/main/src/models/httpRequest.ts#L26",target:"_blank",rel:"noopener noreferrer"},Tn=n("code",null,"request.options",-1),xn=s("."),Pn=n("h2",{id:"mqtt",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#mqtt","aria-hidden":"true"},"#"),s(" MQTT")],-1),Sn=s("By means of the method "),Cn=n("code",null,"MQTT",-1),In=s(" a MQTT Client can be created. "),Hn={href:"https://github.com/mqttjs/MQTT.js",target:"_blank",rel:"noopener noreferrer"},Rn=s("MQTT.js"),jn=s(" opens a TCP or WebSocket Connection to a MQTT Broker. The header "),En=n("code",null,"Topic",-1),An=s(" specifies the topic to be registered (multiple specification allowed)"),Gn=t(`<div class="language-http ext-http line-numbers-mode"><pre class="language-http"><code># @keepStreaming
