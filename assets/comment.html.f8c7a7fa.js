import{d as n}from"./app.98a661aa.js";import{_ as s}from"./httpbook.e371b2d5.js";import{_ as a}from"./plugin-vue_export-helper.21dcd24c.js";const p={},e=n(`<h1 id="comments" tabindex="-1"><a class="header-anchor" href="#comments" aria-hidden="true">#</a> Comments</h1><p>Comments are supported in HTTP Requests.</p><div class="language-html ext-html line-numbers-mode"><pre class="language-html"><code># comment type 1
// comment type 2

/*
  multi line comment
*/
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><div class="custom-container warning"><p class="custom-container-title">WARNING</p><p>Comments used within the request body must start from the beginning of the line (only whitespace before comment start).</p></div><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>The first comment is automatically used as description for this request.</p></div><p><a href="/guide/installation_httpbook">httpBook</a> uses comments to inject markdown documentation</p><p><img src="`+s+`" alt="httpbook"></p><div class="language-http ext-http line-numbers-mode"><pre class="language-http"><code>
/*
# httpbin.org (0.9.2)
...
<span class="token header-name keyword">date:</span> Mon, 21 Jun 2021 19:38:00 GMT
<span class="token header-name keyword">content-type:</span> application/json
<span class="token header-name keyword">content-length:</span> 361
<span class="token header-name keyword">connection:</span> close
<span class="token header-name keyword">server:</span> gunicorn/19.9.0
<span class="token header-name keyword">access-control-allow-origin:</span> *
<span class="token header-name keyword">access-control-allow-credentials:</span> true<span class="token application-json">
...
<span class="token response-status"><span class="token http-version property">HTTP/1.1</span> <span class="token status-code number">200</span> <span class="token reason-phrase string">- OK</span></span>
<span class="token header-name keyword">date:</span> Mon, 21 Jun 2021 19:38:05 GMT
<span class="token header-name keyword">content-type:</span> application/json
<span class="token header-name keyword">content-length:</span> 295
<span class="token header-name keyword">connection:</span> close
<span class="token header-name keyword">server:</span> gunicorn/19.9.0
<span class="token header-name keyword">access-control-allow-origin:</span> *
<span class="token header-name keyword">access-control-allow-credentials:</span> true<span class="token application-json">
...
<span class="token response-status"><span class="token http-version property">HTTP/1.1</span> <span class="token status-code number">200</span> <span class="token reason-phrase string">- OK</span></span>
<span class="token header-name keyword">date:</span> Mon, 21 Jun 2021 19:38:07 GMT
<span class="token header-name keyword">content-type:</span> application/json
<span class="token header-name keyword">content-length:</span> 388
<span class="token header-name keyword">connection:</span> close
<span class="token header-name keyword">server:</span> gunicorn/19.9.0
<span class="token header-name keyword">access-control-allow-origin:</span> *
<span class="token header-name keyword">access-control-allow-credentials:</span> true<span class="token application-json">
...
<span class="token response-status"><span class="token http-version property">HTTP/1.1</span> <span class="token status-code number">200</span> <span class="token reason-phrase string">- OK</span></span>
<span class="token header-name keyword">date:</span> Mon, 21 Jun 2021 19:38:10 GMT
<span class="token header-name keyword">content-type:</span> application/json
<span class="token header-name keyword">content-length:</span> 387
<span class="token header-name keyword">connection:</span> close
<span class="token header-name keyword">server:</span> gunicorn/19.9.0
<span class="token header-name keyword">access-control-allow-origin:</span> *
<span class="token header-name keyword">access-control-allow-credentials:</span> true<span class="token application-json">
...
<span class="token response-status"><span class="token http-version property">HTTP/1.1</span> <span class="token status-code number">200</span> <span class="token reason-phrase string">- OK</span></span>
<span class="token header-name keyword">date:</span> Mon, 21 Jun 2021 19:38:12 GMT
<span class="token header-name keyword">content-type:</span> application/json
<span class="token header-name keyword">content-length:</span> 386
<span class="token header-name keyword">connection:</span> close
<span class="token header-name keyword">server:</span> gunicorn/19.9.0
<span class="token header-name keyword">access-control-allow-origin:</span> *
<span class="token header-name keyword">access-control-allow-credentials:</span> true<span class="token application-json">
...
<span class="token response-status"><span class="token http-version property">HTTP/1.1</span> <span class="token status-code number">200</span> <span class="token reason-phrase string">- OK</span></span>
<span class="token header-name keyword">date:</span> Mon, 21 Jun 2021 19:38:15 GMT
...
<span class="token response-status"><span class="token http-version property">HTTP/1.1</span> <span class="token status-code number">200</span> <span class="token reason-phrase string">- OK</span></span>
<span class="token header-name keyword">date:</span> Mon, 21 Jun 2021 19:38:18 GMT
<span class="token header-name keyword">content-type:</span> text/html; charset=utf-8
<span class="token header-name keyword">content-length:</span> 0
<span class="token header-name keyword">connection:</span> close
<span class="token header-name keyword">server:</span> gunicorn/19.9.0
...
<span class="token response-status"><span class="token http-version property">HTTP/1.1</span> <span class="token status-code number">200</span> <span class="token reason-phrase string">- OK</span></span>
<span class="token header-name keyword">date:</span> Mon, 21 Jun 2021 19:38:24 GMT
<span class="token header-name keyword">content-type:</span> text/html; charset=utf-8
<span class="token header-name keyword">content-length:</span> 0
<span class="token header-name keyword">connection:</span> close
<span class="token header-name keyword">server:</span> gunicorn/19.9.0
...
<span class="token response-status"><span class="token http-version property">HTTP/1.1</span> <span class="token status-code number">200</span> <span class="token reason-phrase string">- OK</span></span>
<span class="token header-name keyword">date:</span> Mon, 21 Jun 2021 19:38:22 GMT
<span class="token header-name keyword">content-type:</span> text/html; charset=utf-8
<span class="token header-name keyword">content-length:</span> 0
<span class="token header-name keyword">connection:</span> close
<span class="token header-name keyword">server:</span> gunicorn/19.9.0
...
<span class="token response-status"><span class="token http-version property">HTTP/1.1</span> <span class="token status-code number">200</span> <span class="token reason-phrase string">- OK</span></span>
<span class="token header-name keyword">date:</span> Mon, 21 Jun 2021 19:38:30 GMT
<span class="token header-name keyword">content-type:</span> text/html; charset=utf-8
<span class="token header-name keyword">content-length:</span> 0
<span class="token header-name keyword">connection:</span> close
<span class="token header-name keyword">server:</span> gunicorn/19.9.0
