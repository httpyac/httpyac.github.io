  ...
  process(n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized, internals) {
    ...
    if (n1 == null) {
      ...
      if (isSVG = isSVG || isTargetSVG(target), dynamicChildren ? (patchBlockChildren(n1.dynamicChildren, dynamicChildren, currentContainer, parentComponent, parentSuspense, isSVG, slotScopeIds), traverseStaticChildren(n1, n2, !0)) : optimized || patchChildren(n1, n2, currentContainer, currentAnchor, parentComponent, parentSuspense, isSVG, slotScopeIds, !1), disabled)
        wasDisabled || moveTeleport(n2, container, mainAnchor, internals, 1);
      else if ((n2.props && n2.props.to) !== (n1.props && n1.props.to)) {
        const nextTarget = n2.target = resolveTarget(n2.props, querySelector);
        nextTarget && moveTeleport(n2, nextTarget, null, internals, 0);
      } else
        wasDisabled && moveTeleport(n2, target, targetAnchor, internals, 1);
    }
    updateCssVars(n2);
  },
...
const vModelText = {
  created(el, { modifiers: { lazy, trim, number } }, vnode) {
    ...
    addEventListener(el, lazy ? "change" : "input", (e) => {
      ...
      trim && (domValue = domValue.trim()), castToNumber && (domValue = toNumber(domValue)), el._assign(domValue);
  ...
  beforeUpdate(el, { value, modifiers: { lazy, trim, number } }, vnode) {
    if (el._assign = getModelAssigner(vnode), el.composing || document.activeElement === el && el.type !== "range" && (lazy || trim && el.value.trim() === value || (number || el.type === "number") && toNumber(el.value) === value))
      return;
    const newValue = value ?? "";
...
const VPNavBarTitle = /* @__PURE__ */ _export_sfc(_sfc_main$10, [["__scopeId", "data-v-d5925166"]]), _imports_0 = "/assets/flex-logo.2489261b.svg";
...
const _hoisted_1$O = { class: "VPNavBarSearch" }, _hoisted_2$C = { class: "DocSearch-Form" }, _hoisted_3$q = /* @__PURE__ */ createBaseVNode("label", {
...
], -1), _hoisted_17 = { class: "DocSearch-Button-Placeholder" }, _hoisted_18 = { class: "DocSearch-Button-Keys" }, _hoisted_19 = /* @__PURE__ */ createBaseVNode("span", { class: "DocSearch-Button-Key" }, "K", -1), _sfc_main$$ = /* @__PURE__ */ defineComponent({
  __name: "Search",
  setup(__props) {
    const { localePath } = useData(), metaKey = ref(), open = ref(!1), searchTerm = ref(), origin = ref(""), input = ref(), INDEX_DATA = ref(), PREVIEW_LOOKUP = ref(), Options = ref(), searchIndex = ref(), buttonLabel = ref("Search"), placeholder = ref("Search docs"), result = computed(() => {
      if (searchTerm.value) {
    ...
    onMounted(async () => {
      var _a2, _b;
      const data = await __vitePreload(() => import("./chunks/virtual_search-data.37dce1ff.js"), []);
      INDEX_DATA.value = data.default.INDEX_DATA, PREVIEW_LOOKUP.value = data.default.PREVIEW_LOOKUP, Options.value = data.default.Options, origin.value = window.location.origin + localePath.value, buttonLabel.value = ((_a2 = Options.value) == null ? void 0 : _a2.buttonLabel) || buttonLabel.value, placeholder.value = ((_b = Options.value) == null ? void 0 : _b.placeholder) || placeholder.value;
            ...
            (openBlock(), createBlock(Teleport, { to: "body" }, [
              withDirectives(createBaseVNode("div", {
                ...
                createBaseVNode("div", {
                  ...
                  createBaseVNode("form", _hoisted_2$C, [
                    _hoisted_3$q,
