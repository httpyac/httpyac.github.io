import{_ as p,r,o as c,c as u,a as e,e as n,b as s,w as a,d as t}from"./app.811fe25e.js";const v={},h=t(`<h1 id="variables" tabindex="-1"><a class="header-anchor" href="#variables" aria-hidden="true">#</a> Variables</h1><p>Variables are used for avoiding unnecessary data duplication in requests or for providing an easy way of switching between environments. They can be used inside request line, header fields, request body or in variable definitions. Each variable is represented by a case-sensitive identifier surrounded by double curly braces.</p><div class="language-http line-numbers-mode" data-ext="http"><pre class="language-http"><code>@foo=bar
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="variable-scope" tabindex="-1"><a class="header-anchor" href="#variable-scope" aria-hidden="true">#</a> Variable Scope</h2><p>The scope is the current context of execution in which variables are &quot;visible&quot; or can be referenced. If a variable or expression is not in the current scope, it will not be available for use.</p>`,5),m=e("code",null,"provideVariables",-1),b=e("li",null,[e("p",null,"File Global Variables: Variables defined in Region without name or request")],-1),g=e("li",null,[e("p",null,"Request Variables: Variables defined in current region")],-1),k={class:"custom-container tip"},y=e("p",{class:"custom-container-title"},"TIP",-1),f={href:"https://httpyac.github.io/guide/variables.html#import-variables",target:"_blank",rel:"noopener noreferrer"},T=e("code",null,"@import",-1),q=e("code",null,"@ref",-1),x=e("code",null,"@forceRef",-1),_=t(`<p>You can also explicitly define variables as global by adding them to the global object in the script.</p><div class="language-http line-numbers-mode" data-ext="http"><pre class="language-http"><code>
<span class="token request-line"><span class="token method property">GET</span> <span class="token request-target url">/anything?foo=bar</span> <span class="token http-version property">HTTP/1.1</span></span>
...
###
<span class="token request-line"><span class="token method property">GET</span> <span class="token request-target url">/anything?bar={{$global.foo}}</span> <span class="token http-version property">HTTP/1.1</span></span>
...
@bar=bar2
<span class="token request-line"><span class="token method property">GET</span> <span class="token request-target url">https://httpbin.org/anything?foo={{foo}}</span> <span class="token http-version property">HTTP/1.1</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>If a required variable is not yet defined, it will also be set lazy</p></div><h2 id="import-variables" tabindex="-1"><a class="header-anchor" href="#import-variables" aria-hidden="true">#</a> Import Variables</h2>`,13),w=e("code",null,"@import",-1),E=t(`<div class="language-http line-numbers-mode" data-ext="http"><pre class="language-http"><code># @import ./variablesInit.http
<span class="token request-line"><span class="token method property">GET</span> <span class="token request-target url">https://httpbin.org/anything?q={{fooExtended}}</span> <span class="token http-version property">HTTP/1.1</span></span>
</code></pre><div class="highlight-lines"><div class="highlight-line"> </div><br></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,1),P=e("code",null,"@ref",-1),G=e("code",null,"@name",-1),H=e("div",{class:"language-http line-numbers-mode","data-ext":"http"},[e("pre",{class:"language-http"},[e("code",null,[n(`# @import ./name.http
# @ref json
...
`)])]),e("div",{class:"highlight-lines"},[e("div",{class:"highlight-line"}," "),e("div",{class:"highlight-line"}," "),e("br"),e("br")]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"})])],-1),I=e("div",{class:"language-http line-numbers-mode","data-ext":"http"},[e("pre",{class:"language-http"},[e("code",null,[n(`# @name json
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="oauth2-openid-connect" tabindex="-1"><a class="header-anchor" href="#oauth2-openid-connect" aria-hidden="true">#</a> OAuth2 / OpenID Connect</h3>`,17),D={href:"https://openid.net/specs/openid-connect-basic-1_0.html",target:"_blank",rel:"noopener noreferrer"},C=t(`<ul><li>Authentication (or Basic) Flow with or without PKCE (grant_type = authorization_code)</li><li>Implicit (or Hybrid) Flow (grant_type = implicit)</li><li>Resource Owner Password Grant (grant_type = password)</li><li>Client Credentials Grant (grant_type = client_credentials)</li><li>Device Authorization Grant (grant_type = device_code)</li></ul><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code>GET /secured_service
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9),$={href:"https://tools.ietf.org/html/rfc8693",target:"_blank",rel:"noopener noreferrer"},S=t(`<div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code>GET /secured_service HTTP/1.1
...
GET /anything?q={{$processEnv USER2}} HTTP/1.1
<span class="token request-line"><span class="token method property">GET</span> <span class="token request-target url">/anything?q={{p<wbr>rocess.env.USER2}}</span> <span class="token http-version property">HTTP/1.1</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="xpath-query" tabindex="-1"><a class="header-anchor" href="#xpath-query" aria-hidden="true">#</a> XPath Query</h3><p>Variables can be extracted from XML using XPath query.</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>$xpath(:&lt;variableName&gt;) &lt;xpath&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>If no variableName is provided and the last response is of Mimetype XML, the last response.body is used</p></blockquote><div class="language-http line-numbers-mode" data-ext="http"><pre class="language-http"><code>### foo
GET /xml

###
# @ref foo
GET /anything?q={{$xpath:foo //@author}}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7);function V(F,M){const i=r("RouterLink"),d=r("ExternalLinkIcon"),l=r("CodeGroupItem"),o=r("CodeGroup");return c(),u("div",null,[h,e("ul",null,[e("li",null,[e("p",null,[n("Environment Variables: All Variables provided with "),m,n(" Hook (e.g. "),s(i,{to:"/guide/environments.html#dotenv"},{default:a(()=>[n("dotenv")]),_:1}),n(")")])]),b,g]),e("div",k,[y,e("p",null,[n("You could expand the visiable scope using "),e("a",f,[T,s(d)]),n(", "),s(i,{to:"/guide/guide/metaData.html#ref-and-forceref"},{default:a(()=>[q,n(" and "),x]),_:1}),n(".")])]),_,e("p",null,[n("The variables are also imported from other files using "),s(i,{to:"/guide/metaData.html#import"},{default:a(()=>[w]),_:1}),n(". Only Variables in File Global Scope are imported.")]),E,e("p",null,[n("To import request Variables, you can also reference ("),s(i,{to:"/guide/metaData.html#ref-and-forceref"},{default:a(()=>[P]),_:1}),n(") named responses ("),s(i,{to:"/guide/metaData.html#name"},{default:a(()=>[G]),_:1}),n(") from other files.")]),s(o,null,{default:a(()=>[s(l,{title:"import.http"},{default:a(()=>[H]),_:1}),s(l,{title:"name.http"},{default:a(()=>[I]),_:1})]),_:1}),A,e("p",null,[n("The following "),e("a",D,[n("Open ID Connect"),s(d)]),n(" flows are supported.")]),C,e("p",null,[n("It is possible to convert the generated token into a token of another realm using "),e("a",$,[n("Token Exchange"),s(d)])]),S,e("p",null,[e("a",z,[n("Intellij dynamic variables"),s(d)]),n(" are supported.")]),Y,e("p",null,[e("a",j,[n("Rest Client dynamic variables"),s(d)]),n(" are partially supported.")]),R])}const N=p(v,[["render",V],["__file","variables.html.vue"]]);export{N as default};
