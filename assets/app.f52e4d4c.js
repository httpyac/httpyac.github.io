...
const toDisplayString = (val) => isString(val) ? val : val == null ? "" : isArray(val) || isObject(val) && (val.toString === objectToString || !isFunction(val.toString)) ? JSON.stringify(val, replacer, 2) : String(val), replacer = (_key, val) => val && val.__v_isRef ? replacer(_key, val.value) : isMap(val) ? {
  ...
  i > -1 && arr.splice(i, 1);
}, hasOwnProperty = Object.prototype.hasOwnProperty, hasOwn = (val, key) => hasOwnProperty.call(val, key), isArray = Array.isArray, isMap = (val) => toTypeString(val) === "[object Map]", isSet = (val) => toTypeString(val) === "[object Set]", isFunction = (val) => typeof val == "function", isString = (val) => typeof val == "string", isSymbol = (val) => typeof val == "symbol", isObject = (val) => val !== null && typeof val == "object", isPromise = (val) => isObject(val) && isFunction(val.then) && isFunction(val.catch), objectToString = Object.prototype.toString, toTypeString = (value) => objectToString.call(value), toRawType = (value) => toTypeString(value).slice(8, -1), isPlainObject = (val) => toTypeString(val) === "[object Object]", isIntegerKey = (key) => isString(key) && key !== "NaN" && key[0] !== "-" && "" + parseInt(key, 10) === key, isReservedProp = /* @__PURE__ */ makeMap(
...
), get = /* @__PURE__ */ createGetter(), shallowGet = /* @__PURE__ */ createGetter(!1, !0), readonlyGet = /* @__PURE__ */ createGetter(!0), arrayInstrumentations = /* @__PURE__ */ createArrayInstrumentations();
...
const set = /* @__PURE__ */ createSetter(), shallowSet = /* @__PURE__ */ createSetter(!0);
...
function get$1(target, key, isReadonly2 = !1, isShallow2 = !1) {
...
function has$1(key, isReadonly2 = !1) {
...
function triggerRefValue(ref2, newVal) {
  ref2 = toRaw(ref2), ref2.dep && triggerEffects(ref2.dep);
}
function isRef(r) {
...
function emit$1(instance, event, ...rawArgs) {
  ...
  if (modelArg && modelArg in props) {
    ...
    trim && (args = rawArgs.map((a) => isString(a) ? a.trim() : a)), number && (args = rawArgs.map(toNumber));
  }
  let handlerName, handler = props[handlerName = toHandlerKey(event)] || props[handlerName = toHandlerKey(camelize(event))];
...
function renderComponentRoot(instance) {
  ...
  try {
    if (vnode.shapeFlag & 4) {
      ...
      result = normalizeVNode(render2.length > 1 ? render2(props, { attrs, slots, emit }) : render2(props, null)), fallthroughAttrs = Component.props ? attrs : getFunctionalFallthrough(attrs);
    }
  } catch (err) {
...
function resolveTransitionHooks(vnode, props, state, instance) {
  const { appear, mode, persisted = !1, onBeforeEnter, onEnter, onAfterEnter, onEnterCancelled, onBeforeLeave, onLeave, onAfterLeave, onLeaveCancelled, onBeforeAppear, onAppear, onAfterAppear, onAppearCancelled } = props, key = String(vnode.key), leavingVNodesCache = getLeavingNodesForType(state, vnode), callHook2 = (hook, args) => {
    ...
    leave(el, remove2) {
      ...
      if (el._enterCb && el._enterCb(!0), state.isUnmounting)
        return remove2();
...
function resolveAsset(type, name, warnMissing = !0, maybeSelfReference = !1) {
  ...
  if (instance) {
    ...
    if (type === COMPONENTS) {
      const selfName = getComponentName(Component, !1);
...
function renderSlot(slots, name, props = {}, fallback, noSlotted) {
  ...
  const validSlotContent = slot && ensureValidVNode(slot(props)), rendered = createBlock(Fragment, {
...
const getPublicInstance = (i) => i ? isStatefulComponent(i) ? getExposeProxy(i) || i.proxy : getPublicInstance(i.parent) : null, publicPropertiesMap = /* @__PURE__ */ extend(/* @__PURE__ */ Object.create(null), {
  $: (i) => i,
  $el: (i) => i.vnode.el,
  $data: (i) => i.data,
  $props: (i) => i.props,
  ...
  get({ _: instance }, key) {
    ...
    if (key[0] !== "$") {
      ...
      if (n !== void 0)
        ...
        if ((normalizedProps = instance.propsOptions[0]) && hasOwn(normalizedProps, key))
    ...
    if ((cssModule = type.__cssModules) && (cssModule = cssModule[key]))
      return cssModule;
    if (ctx !== EMPTY_OBJ && hasOwn(ctx, key))
      return accessCache[key] = 4, ctx[key];
    if (globalProperties = appContext.config.globalProperties, hasOwn(globalProperties, key))
...
function resolveInjections(injectOptions, ctx, checkDuplicateProperties = NOOP, unwrapRef = !1) {
  ...
  for (const key in injectOptions) {
    ...
    let injected;
    isObject(opt) ? "default" in opt ? injected = inject(opt.from || key, opt.default, !0) : injected = inject(opt.from || key) : injected = inject(opt), isRef(injected) && unwrapRef ? Object.defineProperty(ctx, key, {
      enumerable: !0,
      configurable: !0,
      get: () => injected.value,
...
function updateProps(instance, rawProps, rawPrevProps, optimized) {
  ...
  if ((optimized || patchFlag > 0) && !(patchFlag & 16)) {
    ...
    for (const key in rawCurrentProps)
      (!rawProps || !hasOwn(rawProps, key) && ((kebabKey = hyphenate(key)) === key || !hasOwn(rawProps, kebabKey))) && (options ? rawPrevProps && (rawPrevProps[key] !== void 0 || rawPrevProps[kebabKey] !== void 0) && (props[key] = resolvePropValue(options, rawCurrentProps, key, void 0, instance, !0)) : delete props[key]);
    ...
    for (const key in raw) {
      ...
      if (validatePropName(normalizedKey)) {
        ...
        if (prop) {
          ...
          prop[0] = booleanIndex > -1, prop[1] = stringIndex < 0 || booleanIndex < stringIndex, (booleanIndex > -1 || hasOwn(prop, "default")) && needCastKeys.push(normalizedKey);
        }
      }
    }
...
function createHydrationFunctions(rendererInternals) {
  const { mt: mountComponent, p: patch, o: { patchProp: patchProp2, createText, nextSibling, parentNode, remove: remove2, insert, createComment } } = rendererInternals, hydrate = (vnode, container) => {
    ...
    if (forcePatchValue || patchFlag !== -1) {
      ...
      }, parentSuspense), shapeFlag & 16 && !(props && (props.innerHTML || props.textContent))) {
...
function baseCreateRenderer(options, createHydrationFns) {
  ...
  const { insert: hostInsert, remove: hostRemove, patchProp: hostPatchProp, createElement: hostCreateElement, createText: hostCreateText, createComment: hostCreateComment, setText: hostSetText, setElementText: hostSetElementText, parentNode: hostParentNode, nextSibling: hostNextSibling, setScopeId: hostSetScopeId = NOOP, insertStaticContent: hostInsertStaticContent } = options, patch = (n1, n2, container, anchor = null, parentComponent = null, parentSuspense = null, isSVG = !1, slotScopeIds = null, optimized = !!n2.dynamicChildren) => {
    ...
    if (el = vnode.el = hostCreateElement(vnode.type, isSVG, props && props.is, props), shapeFlag & 8 ? hostSetElementText(el, vnode.children) : shapeFlag & 16 && mountChildren(vnode.children, el, null, parentComponent, parentSuspense, isSVG && type !== "foreignObject", slotScopeIds, optimized), dirs && invokeDirectiveHook(vnode, null, parentComponent, "created"), props) {
      for (const key in props)
    ...
    for (let i = 0; i < newChildren.length; i++) {
      const oldVNode = oldChildren[i], newVNode = newChildren[i], container = oldVNode.el && (oldVNode.type === Fragment || !isSameVNodeType(oldVNode, newVNode) || oldVNode.shapeFlag & 70) ? hostParentNode(oldVNode.el) : fallbackContainer;
    ...
    if (i > e1) {
      ...
      for (j = increasingNewIndexSequence.length - 1, i = toBePatched - 1; i >= 0; i--) {
        ...
        newIndexToOldIndexMap[i] === 0 ? patch(null, nextChild, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized) : moved && (j < 0 || i !== increasingNewIndexSequence[j] ? move(nextChild, container, anchor, 2) : j--);
      }
    }
    ...
    if (shouldInvokeVnodeHook && (vnodeHook = props && props.onVnodeBeforeUnmount) && invokeVNodeHook(vnodeHook, parentComponent, vnode), shapeFlag & 6)
      ...
      shouldInvokeDirs && invokeDirectiveHook(vnode, null, parentComponent, "beforeUnmount"), shapeFlag & 64 ? vnode.type.remove(vnode, parentComponent, parentSuspense, optimized, internals, doRemove) : dynamicChildren && (type !== Fragment || patchFlag > 0 && patchFlag & 64) ? unmountChildren(dynamicChildren, parentComponent, parentSuspense, !1, !0) : (type === Fragment && patchFlag & 384 || !optimized && shapeFlag & 16) && unmountChildren(children, parentComponent, parentSuspense), doRemove && remove2(vnode);
    }
...
const isTeleport = (type) => type.__isTeleport, Fragment = Symbol(void 0), Text = Symbol(void 0), Comment = Symbol(void 0), Static = Symbol(void 0), blockStack = [];
...
function createElementBlock(type, props, children, patchFlag, dynamicProps, shapeFlag) {
  return setupBlock(createBaseVNode(type, props, children, patchFlag, dynamicProps, shapeFlag, !0));
}
function createBlock(type, props, children, patchFlag, dynamicProps) {
  return setupBlock(createVNode(type, props, children, patchFlag, dynamicProps, !0));
}
...
const InternalObjectKey = "__vInternal", normalizeKey = ({ key }) => key ?? null, normalizeRef = ({ ref: ref2, ref_key, ref_for }) => ref2 != null ? isString(ref2) || isRef(ref2) || isFunction(ref2) ? { i: currentRenderingInstance, r: ref2, k: ref_key, f: !!ref_for } : ref2 : null;
...
function createComponentInstance(vnode, parent, suspense) {
  ...
  return instance.ctx = { _: instance }, instance.root = parent ? parent.root : instance, instance.emit = emit$1.bind(null, instance), vnode.ce && vnode.ce(instance), instance;
}
...
const ssrContextKey = Symbol(""), useSSRContext = () => inject(ssrContextKey), version = "3.2.45", svgNS = "http://www.w3.org/2000/svg", doc = typeof document < "u" ? document : null, templateContainer = doc && /* @__PURE__ */ doc.createElement("template"), nodeOps = {
...
function patchDOMProp(el, key, value, prevChildren, parentComponent, parentSuspense, unmountChildren) {
  ...
  if (key === "value" && el.tagName !== "PROGRESS" && !el.tagName.includes("-")) {
    ...
    (el.value !== newValue || el.tagName === "OPTION") && (el.value = newValue), value == null && el.removeAttribute(key);
    return;
  }
  let needRemove = !1;
  if (value === "" || value == null) {
...
function useCssVars(getter) {
  ...
  const updateTeleports = instance.ut = (vars = getter(instance.proxy)) => {
    ...
    setVarsOnVNode(instance.subTree, vars), updateTeleports(vars);
  };
  watchPostEffect(setVars), onMounted(() => {
    const ob = new MutationObserver(setVars);
    ob.observe(instance.subTree.el.parentNode, { childList: !0 }), onUnmounted(() => ob.disconnect());
  });
}
function setVarsOnVNode(vnode, vars) {
  if (vnode.shapeFlag & 128) {
    const suspense = vnode.suspense;
    vnode = suspense.activeBranch, suspense.pendingBranch && !suspense.isHydrating && suspense.effects.push(() => {
  ...
  if (vnode.shapeFlag & 1 && vnode.el)
    ...
    let { el, anchor } = vnode;
    for (; el && (setVarsOnNode(el, vars), el !== anchor); )
      el = el.nextSibling;
  }
}
...
const VPBadge = /* @__PURE__ */ _export_sfc(_sfc_main$14, [["__scopeId", "data-v-350d3852"]]), siteData = JSON.parse('{"lang":"en-US","title":"httpYac","description":"Quickly and easily send REST, SOAP, GraphQL and gRPC requests","base":"/","head":[],"appearance":true,"themeConfig":{"logo":"/favicon.png","nav":[{"text":"Guide","items":[{"text":"Installation","items":[{"text":"CLI","link":"/guide/installation_cli"},{"text":"VSCode","link":"/guide/installation_vscode"},{"text":"VSCode Notebook","link":"/guide/installation_httpbook"},{"text":"Docker","link":"/guide/installation_docker"}]},{"text":"Language","items":[{"text":"Request","link":"/guide/request"},{"text":"MetaData","link":"/guide/metaData"},{"text":"Variables","link":"/guide/variables"},{"text":"Environments","link":"/guide/environments"},{"text":"Scripting","link":"/guide/scripting"},{"text":"Comment","link":"/guide/comment"},{"text":"Hooks","link":"/guide/hooks"},{"text":"Response","link":"/guide/response"},{"text":"Injected Languages","link":"/guide/injected_languages"}]}]},{"text":"Support","items":[{"text":"Examples","link":"/guide/examples"},{"text":"Troubleshooting","link":"/guide/troubleshooting"}]},{"text":"Configuration","link":"/config/"},{"text":"Plugins","items":[{"text":"Development Guide","link":"/plugins/"},{"text":"API Reference","link":"/plugins/plugin-api.md"}]},{"text":"Source","items":[{"text":"httpyac CLI","link":"https://github.com/anweber/httpyac"},{"text":"vscode-httpyac","link":"https://github.com/anweber/vscode-httpyac"},{"text":"httpbook","link":"https://github.com/anweber/httpbook"},{"text":"httpyac.github.io","link":"https://github.com/httpyac/httpac.github.io"}]}],"sidebar":[{"text":"Guide","items":[{"text":"Installation","items":[{"text":"CLI","link":"/guide/installation_cli"},{"text":"VSCode","link":"/guide/installation_vscode"},{"text":"VSCode Notebook","link":"/guide/installation_httpbook"},{"text":"Docker","link":"/guide/installation_docker"}]},{"text":"Language","items":[{"text":"Request","link":"/guide/request"},{"text":"MetaData","link":"/guide/metaData"},{"text":"Variables","link":"/guide/variables"},{"text":"Environments","link":"/guide/environments"},{"text":"Scripting","link":"/guide/scripting"},{"text":"Comment","link":"/guide/comment"},{"text":"Hooks","link":"/guide/hooks"},{"text":"Response","link":"/guide/response"},{"text":"Injected Languages","link":"/guide/injected_languages"}]}]},{"text":"Support","items":[{"text":"Examples","link":"/guide/examples"},{"text":"Troubleshooting","link":"/guide/troubleshooting"}]},{"text":"Plugins","items":[{"text":"Development Guide","link":"/plugins/"},{"text":"API reference","link":"/plugins/plugin-api.md"}]}],"footer":{"copyright":"MIT Licensed | Copyright © 2020-present <a href=\\"https://github.com/anweber\\">Andreas Weber</a>"}},"locales":{},"langs":{},"scrollOffset":90,"cleanUrls":"disabled"}'), EXTERNAL_URL_RE = /^[a-z]+:/i, PATHNAME_PROTOCOL_RE = /^pathname:\/\//, APPEARANCE_KEY = "vitepress-theme-appearance", inBrowser$1 = typeof window < "u", notFoundPageData = {
  relativePath: "",
  title: "404",
...
function findMatchRoot(route, roots) {
  roots.sort((a, b) => {
    ...
    return levelDelta !== 0 ? levelDelta : b.length - a.length;
  });
...
function createLangDictionary(siteData2) {
  const { locales } = siteData2.themeConfig || {}, siteLocales = siteData2.locales;
  return locales && siteLocales ? Object.keys(locales).reduce((langs, path) => (langs[path] = {
...
function resolveSiteDataByRoute(siteData2, route) {
  ...
  const localeData = resolveLocales(siteData2.locales || {}, route), localeThemeConfig = resolveLocales(siteData2.themeConfig.locales || {}, route);
...
function cleanRoute(siteData2, route) {
  if (!inBrowser$1)
    return route;
  const base = siteData2.base, baseWithoutSuffix = base.endsWith("/") ? base.slice(0, -1) : base;
...
function pathToFile(path) {
  ...
  if (pagePath = decodeURIComponent(pagePath), pagePath = pagePath.replace(/\/$/, "/index"), inBrowser$1) {
    const base = "/";
    pagePath = sanitizeFileName(pagePath.slice(base.length).replace(/\//g, "_") || "index") + ".md";
    let pageHash = __VP_HASH_MAP__[pagePath.toLowerCase()];
    !pageHash && pagePath.endsWith("_index.md") && (pagePath = pagePath.slice(0, -9) + ".md", pageHash = __VP_HASH_MAP__[pagePath.toLowerCase()]), pagePath = `${base}assets/${pagePath}.${pageHash}.js`;
  } else
...
function initData(route) {
  ...
  return {
    ...
    localePath: computed(() => {
      const { langs, lang } = site.value, path = Object.keys(langs).find((langPath) => langs[langPath].lang === lang);
...
function createRouter(loadPageModule, fallbackComponent) {
  ...
  async function go(href = inBrowser$1 ? location.href : "/") {
    ...
    siteDataRef.value.cleanUrls === "disabled" && !url.pathname.endsWith("/") && !url.pathname.endsWith(".html") && (url.pathname += ".html", href = url.pathname + url.search + url.hash), inBrowser$1 && (history.replaceState({ scrollPosition: window.scrollY }, document.title), history.pushState(null, "", href)), await loadPage(href), await ((_b = router.onAfterRouteChanged) == null ? void 0 : _b.call(router, href));
  }
  ...
  async function loadPage(href, scrollPosition = 0, isRetry = !1) {
    ...
    try {
      ...
      if (latestPendingPath === pendingPath) {
        ...
        route.path = inBrowser$1 ? pendingPath : withBase(pendingPath), route.component = markRaw(comp), route.data = markRaw(__pageData), inBrowser$1 && nextTick(() => {
      ...
      latestPendingPath === pendingPath && (latestPendingPath = null, route.path = inBrowser$1 ? pendingPath : withBase(pendingPath), route.component = fallbackComponent ? markRaw(fallbackComponent) : null, route.data = notFoundPageData);
    }
  }
  return inBrowser$1 && (window.addEventListener("click", (e) => {
    if (e.target.closest("button"))
      return;
    const link2 = e.target.closest("a");
    if (link2 && !link2.closest(".vp-raw") && !link2.download) {
      const { href, origin, pathname, hash, search, target } = link2, currentUrl = window.location, extMatch = pathname.match(/\.\w+$/);
      !e.ctrlKey && !e.shiftKey && !e.altKey && !e.metaKey && target !== "_blank" && origin === currentUrl.origin && !(extMatch && extMatch[0] !== ".html") && (e.preventDefault(), pathname === currentUrl.pathname && search === currentUrl.search ? hash && hash !== currentUrl.hash && (history.pushState(null, "", hash), window.dispatchEvent(new Event("hashchange")), scrollTo(link2, hash, link2.classList.contains("header-anchor"))) : go(href));
    }
...
const HASH_RE = /#.*$/, EXT_RE = /(index)?\.(md|html)$/, inBrowser = typeof window < "u", hashRef = ref(inBrowser ? location.hash : "");
...
function isActive(currentPath, matchPath, asRegex = !1) {
  ...
  return hashMatch ? hashRef.value === hashMatch[0] : !0;
}
...
function normalizeLink(url) {
  ...
  const { site } = useData(), { pathname, search, hash } = new URL(url, "http://example.com"), normalizedPath = pathname.endsWith("/") || pathname.endsWith(".html") ? url : `${pathname.replace(/(\.md)?$/, site.value.cleanUrls === "disabled" ? ".html" : "")}${search}${hash}`;
...
function getFlatSideBarLinks(sidebar) {
  ...
  function recursivelyExtractLinks(items) {
    for (const item of items)
      item.link && links.push({ ...item, link: item.link }), "items" in item && recursivelyExtractLinks(item.items);
  }
...
function useSidebar() {
  ...
  }), hasSidebar = computed(() => frontmatter.value.sidebar !== !1 && sidebar.value.length > 0 && frontmatter.value.layout !== "home"), hasAside = computed(() => frontmatter.value.layout !== "home" && frontmatter.value.aside !== !1), isSidebarEnabled = computed(() => hasSidebar.value && is960.value);
  function open() {
    isOpen.value = !0;
  }
  function close() {
...
const VPSkipLink = /* @__PURE__ */ _export_sfc(_sfc_main$13, [["__scopeId", "data-v-151f2593"]]), _hoisted_1$R = {
  key: 0,
  class: "VPBackdrop"
  ...
  setup(__props) {
    return (_ctx, _cache) => (openBlock(), createBlock(Transition, { name: "fade" }, {
      default: withCtx(() => [
        __props.show ? (openBlock(), createElementBlock("div", _hoisted_1$R)) : createCommentVNode("", !0)
      ]),
      _: 1
    }));
  }
});
const VPBackdrop = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__scopeId", "data-v-c7c65b34"]]);
function useNav() {
...
const _hoisted_1$Q = ["src", "alt"], __default__ = {
  inheritAttrs: !1
...
const VPImage = /* @__PURE__ */ _export_sfc(_sfc_main$11, [["__scopeId", "data-v-6db2186b"]]), _hoisted_1$P = ["href"], _sfc_main$10 = /* @__PURE__ */ defineComponent({
  __name: "VPNavBarTitle",
  setup(__props) {
    const { site, theme: theme2 } = useData(), { hasSidebar } = useSidebar();
...
const _hoisted_1$O = {
  ...
  "aria-label": "Search"
}, _hoisted_3$q = { class: "DocSearch-Button-Container" }, _hoisted_4$g = /* @__PURE__ */ createBaseVNode("svg", {
...
], -1), _hoisted_5$8 = { class: "DocSearch-Button-Placeholder" }, _hoisted_6$7 = /* @__PURE__ */ createBaseVNode("span", { class: "DocSearch-Button-Keys" }, [
  ...
  setup(__props) {
    ...
    const VPAlgoliaSearchBox = () => null, { theme: theme2 } = useData(), loaded = ref(!1), metaKey = ref("'Meta'");
    onMounted(() => {
      if (!theme2.value.algolia)
        return;
      metaKey.value = /(Mac|iPhone|iPod|iPad)/i.test(navigator.platform) ? "'⌘'" : "'Ctrl'";
      const handleSearchHotKey = (e) => {
        e.key === "k" && (e.ctrlKey || e.metaKey) && (e.preventDefault(), load(), remove2());
      }, remove2 = () => {
        window.removeEventListener("keydown", handleSearchHotKey);
      };
      window.addEventListener("keydown", handleSearchHotKey), onUnmounted(remove2);
    });
    function load() {
      loaded.value || (loaded.value = !0);
    }
    return (_ctx, _cache) => {
      var _a2;
...
const _sfc_main$_ = {}, _hoisted_1$N = {
  ...
  viewBox: "0 0 24 24",
  width: "24px"
}, _hoisted_2$B = /* @__PURE__ */ createBaseVNode("path", {
  d: "M0 0h24v24H0V0z",
  fill: "none"
}, null, -1), _hoisted_3$p = /* @__PURE__ */ createBaseVNode("path", { d: "M9 5v2h6.59L4 18.59 5.41 20 17 8.41V15h2V5H9z" }, null, -1), _hoisted_4$f = [
  _hoisted_2$B,
  _hoisted_3$p
];
...
const VPIconExternalLink = /* @__PURE__ */ _export_sfc(_sfc_main$_, [["render", _sfc_render$d]]), _sfc_main$Z = /* @__PURE__ */ defineComponent({
  __name: "VPLink",
  props: {
    href: null,
    noIcon: { type: Boolean }
  ...
  setup(__props) {
    const props = __props, isExternal2 = computed(() => props.href && EXTERNAL_URL_RE.test(props.href));
    return (_ctx, _cache) => (openBlock(), createBlock(resolveDynamicComponent(__props.href ? "a" : "span"), {
...
const VPLink = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["__scopeId", "data-v-3c355974"]]), _sfc_main$Y = /* @__PURE__ */ defineComponent({
...
const VPNavBarMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$Y, [["__scopeId", "data-v-47a2263e"]]), focusedElement = ref();
...
const _sfc_main$X = {}, _hoisted_1$M = {
  xmlns: "http://www.w3.org/2000/svg",
  "aria-hidden": "true",
  focusable: "false",
  viewBox: "0 0 24 24"
}, _hoisted_2$A = /* @__PURE__ */ createBaseVNode("path", { d: "M12,16c-0.3,0-0.5-0.1-0.7-0.3l-6-6c-0.4-0.4-0.4-1,0-1.4s1-0.4,1.4,0l5.3,5.3l5.3-5.3c0.4-0.4,1-0.4,1.4,0s0.4,1,0,1.4l-6,6C12.5,15.9,12.3,16,12,16z" }, null, -1), _hoisted_3$o = [
  _hoisted_2$A
];
function _sfc_render$c(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$M, _hoisted_3$o);
}
const VPIconChevronDown = /* @__PURE__ */ _export_sfc(_sfc_main$X, [["render", _sfc_render$c]]), _sfc_main$W = {}, _hoisted_1$L = {
  xmlns: "http://www.w3.org/2000/svg",
  "aria-hidden": "true",
  focusable: "false",
  viewBox: "0 0 24 24"
}, _hoisted_2$z = /* @__PURE__ */ createBaseVNode("circle", {
  cx: "12",
  cy: "12",
  r: "2"
}, null, -1), _hoisted_3$n = /* @__PURE__ */ createBaseVNode("circle", {
  cx: "19",
  cy: "12",
  r: "2"
}, null, -1), _hoisted_4$e = /* @__PURE__ */ createBaseVNode("circle", {
  cx: "5",
  cy: "12",
  r: "2"
}, null, -1), _hoisted_5$7 = [
...
const VPIconMoreHorizontal = /* @__PURE__ */ _export_sfc(_sfc_main$W, [["render", _sfc_render$b]]), _hoisted_1$K = { class: "VPMenuLink" }, _sfc_main$V = /* @__PURE__ */ defineComponent({
  __name: "VPMenuLink",
  props: {
    item: null
  },
...
const VPMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$V, [["__scopeId", "data-v-e8e0fb1d"]]), _hoisted_1$J = { class: "VPMenuGroup" }, _hoisted_2$y = {
  key: 0,
  class: "title"
  ...
  setup(__props) {
    return (_ctx, _cache) => (openBlock(), createElementBlock("div", _hoisted_1$J, [
      __props.text ? (openBlock(), createElementBlock("p", _hoisted_2$y, toDisplayString(__props.text), 1)) : createCommentVNode("", !0),
...
const VPMenuGroup = /* @__PURE__ */ _export_sfc(_sfc_main$U, [["__scopeId", "data-v-9ca52130"]]), _hoisted_1$I = { class: "VPMenu" }, _hoisted_2$x = {
  key: 0,
  class: "items"
...
const VPMenu = /* @__PURE__ */ _export_sfc(_sfc_main$T, [["__scopeId", "data-v-1c5d0cfc"]]), _hoisted_1$H = ["aria-expanded", "aria-label"], _hoisted_2$w = {
  key: 0,
  class: "text"
}, _hoisted_3$m = { class: "menu" }, _sfc_main$S = /* @__PURE__ */ defineComponent({
  __name: "VPFlyout",
  props: {
    icon: null,
    button: null,
...
const VPFlyout = /* @__PURE__ */ _export_sfc(_sfc_main$S, [["__scopeId", "data-v-6ffb57d3"]]), _sfc_main$R = /* @__PURE__ */ defineComponent({
...
}), _withScopeId$a = (n) => (pushScopeId("data-v-f83db6ba"), n = n(), popScopeId(), n), _hoisted_1$G = {
  key: 0,
  "aria-labelledby": "main-nav-aria-label",
  class: "VPNavBarMenu"
}, _hoisted_2$v = /* @__PURE__ */ _withScopeId$a(() => /* @__PURE__ */ createBaseVNode("span", {
  id: "main-nav-aria-label",
  class: "visually-hidden"
}, "Main Navigation", -1)), _sfc_main$Q = /* @__PURE__ */ defineComponent({
  __name: "VPNavBarMenu",
  setup(__props) {
    const { theme: theme2 } = useData();
    return (_ctx, _cache) => unref(theme2).nav ? (openBlock(), createElementBlock("nav", _hoisted_1$G, [
      _hoisted_2$v,
...
const VPNavBarMenu = /* @__PURE__ */ _export_sfc(_sfc_main$Q, [["__scopeId", "data-v-f83db6ba"]]), _sfc_main$P = {}, _hoisted_1$F = {
  xmlns: "http://www.w3.org/2000/svg",
  "aria-hidden": "true",
  focusable: "false",
  viewBox: "0 0 24 24"
}, _hoisted_2$u = /* @__PURE__ */ createBaseVNode("path", {
  d: "M0 0h24v24H0z",
  fill: "none"
}, null, -1), _hoisted_3$l = /* @__PURE__ */ createBaseVNode("path", {
...
const VPIconLanguages = /* @__PURE__ */ _export_sfc(_sfc_main$P, [["render", _sfc_render$a]]), _hoisted_1$E = { class: "items" }, _hoisted_2$t = { class: "title" }, _sfc_main$O = /* @__PURE__ */ defineComponent({
  __name: "VPNavBarTranslations",
  setup(__props) {
    const { theme: theme2 } = useData();
    return (_ctx, _cache) => unref(theme2).localeLinks ? (openBlock(), createBlock(VPFlyout, {
      key: 0,
      ...
      default: withCtx(() => [
        createBaseVNode("div", _hoisted_1$E, [
          ...
          (openBlock(!0), createElementBlock(Fragment, null, renderList(unref(theme2).localeLinks.items, (locale) => (openBlock(), createBlock(VPMenuLink, {
            key: locale.link,
            item: locale
          }, null, 8, ["item"]))), 128))
        ])
...
const _sfc_main$N = {}, _hoisted_1$D = {
  class: "VPSwitch",
  type: "button",
  role: "switch"
}, _hoisted_2$s = { class: "check" }, _hoisted_3$k = {
  key: 0,
  class: "icon"
};
...
const VPSwitch = /* @__PURE__ */ _export_sfc(_sfc_main$N, [["render", _sfc_render$9], ["__scopeId", "data-v-eba7420e"]]), _sfc_main$M = {}, _hoisted_1$C = {
  xmlns: "http://www.w3.org/2000/svg",
  "aria-hidden": "true",
  focusable: "false",
  viewBox: "0 0 24 24"
}, _hoisted_2$r = /* @__PURE__ */ createStaticVNode('<path d="M12,18c-3.3,0-6-2.7-6-6s2.7-6,6-6s6,2.7,6,6S15.3,18,12,18zM12,8c-2.2,0-4,1.8-4,4c0,2.2,1.8,4,4,4c2.2,0,4-1.8,4-4C16,9.8,14.2,8,12,8z"></path><path d="M12,4c-0.6,0-1-0.4-1-1V1c0-0.6,0.4-1,1-1s1,0.4,1,1v2C13,3.6,12.6,4,12,4z"></path><path d="M12,24c-0.6,0-1-0.4-1-1v-2c0-0.6,0.4-1,1-1s1,0.4,1,1v2C13,23.6,12.6,24,12,24z"></path><path d="M5.6,6.6c-0.3,0-0.5-0.1-0.7-0.3L3.5,4.9c-0.4-0.4-0.4-1,0-1.4s1-0.4,1.4,0l1.4,1.4c0.4,0.4,0.4,1,0,1.4C6.2,6.5,5.9,6.6,5.6,6.6z"></path><path d="M19.8,20.8c-0.3,0-0.5-0.1-0.7-0.3l-1.4-1.4c-0.4-0.4-0.4-1,0-1.4s1-0.4,1.4,0l1.4,1.4c0.4,0.4,0.4,1,0,1.4C20.3,20.7,20,20.8,19.8,20.8z"></path><path d="M3,13H1c-0.6,0-1-0.4-1-1s0.4-1,1-1h2c0.6,0,1,0.4,1,1S3.6,13,3,13z"></path><path d="M23,13h-2c-0.6,0-1-0.4-1-1s0.4-1,1-1h2c0.6,0,1,0.4,1,1S23.6,13,23,13z"></path><path d="M4.2,20.8c-0.3,0-0.5-0.1-0.7-0.3c-0.4-0.4-0.4-1,0-1.4l1.4-1.4c0.4-0.4,1-0.4,1.4,0s0.4,1,0,1.4l-1.4,1.4C4.7,20.7,4.5,20.8,4.2,20.8z"></path><path d="M18.4,6.6c-0.3,0-0.5-0.1-0.7-0.3c-0.4-0.4-0.4-1,0-1.4l1.4-1.4c0.4-0.4,1-0.4,1.4,0s0.4,1,0,1.4l-1.4,1.4C18.9,6.5,18.6,6.6,18.4,6.6z"></path>', 9), _hoisted_11$1 = [
  _hoisted_2$r
];
function _sfc_render$8(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$C, _hoisted_11$1);
}
const VPIconSun = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["render", _sfc_render$8]]), _sfc_main$L = {}, _hoisted_1$B = {
  xmlns: "http://www.w3.org/2000/svg",
  "aria-hidden": "true",
  focusable: "false",
  viewBox: "0 0 24 24"
}, _hoisted_2$q = /* @__PURE__ */ createBaseVNode("path", { d: "M12.1,22c-0.3,0-0.6,0-0.9,0c-5.5-0.5-9.5-5.4-9-10.9c0.4-4.8,4.2-8.6,9-9c0.4,0,0.8,0.2,1,0.5c0.2,0.3,0.2,0.8-0.1,1.1c-2,2.7-1.4,6.4,1.3,8.4c2.1,1.6,5,1.6,7.1,0c0.3-0.2,0.7-0.3,1.1-0.1c0.3,0.2,0.5,0.6,0.5,1c-0.2,2.7-1.5,5.1-3.6,6.8C16.6,21.2,14.4,22,12.1,22zM9.3,4.4c-2.9,1-5,3.6-5.2,6.8c-0.4,4.4,2.8,8.3,7.2,8.7c2.1,0.2,4.2-0.4,5.8-1.8c1.1-0.9,1.9-2.1,2.4-3.4c-2.5,0.9-5.3,0.5-7.5-1.1C9.2,11.4,8.1,7.7,9.3,4.4z" }, null, -1), _hoisted_3$j = [
  _hoisted_2$q
];
function _sfc_render$7(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$B, _hoisted_3$j);
}
const VPIconMoon = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["render", _sfc_render$7]]), _sfc_main$K = /* @__PURE__ */ defineComponent({
...
const VPSwitchAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["__scopeId", "data-v-481098f9"]]), _hoisted_1$A = {
  key: 0,
  ...
  setup(__props) {
    const { site } = useData();
    return (_ctx, _cache) => unref(site).appearance ? (openBlock(), createElementBlock("div", _hoisted_1$A, [
      createVNode(VPSwitchAppearance)
    ])) : createCommentVNode("", !0);
  }
});
const VPNavBarAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["__scopeId", "data-v-a3e7452b"]]), icons = {
...
}, _hoisted_1$z = ["href", "innerHTML"], _sfc_main$I = /* @__PURE__ */ defineComponent({
  __name: "VPSocialLink",
  props: {
    icon: null,
    link: null
...
const VPSocialLink = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["__scopeId", "data-v-e57698f6"]]), _hoisted_1$y = { class: "VPSocialLinks" }, _sfc_main$H = /* @__PURE__ */ defineComponent({
  __name: "VPSocialLinks",
  props: {
    links: null
  },
  setup(__props) {
    return (_ctx, _cache) => (openBlock(), createElementBlock("div", _hoisted_1$y, [
...
const VPSocialLinks = /* @__PURE__ */ _export_sfc(_sfc_main$H, [["__scopeId", "data-v-f6988cfb"]]), _sfc_main$G = /* @__PURE__ */ defineComponent({
...
const VPNavBarSocialLinks = /* @__PURE__ */ _export_sfc(_sfc_main$G, [["__scopeId", "data-v-738bef5a"]]), _withScopeId$9 = (n) => (pushScopeId("data-v-e4361c82"), n = n(), popScopeId(), n), _hoisted_1$x = {
  key: 0,
  class: "group"
}, _hoisted_2$p = { class: "trans-title" }, _hoisted_3$i = {
  key: 1,
  class: "group"
}, _hoisted_4$c = { class: "item appearance" }, _hoisted_5$6 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("p", { class: "label" }, "Appearance", -1)), _hoisted_6$6 = { class: "appearance-action" }, _hoisted_7$4 = {
  key: 2,
  class: "group"
}, _hoisted_8$3 = { class: "item social-links" }, _sfc_main$F = /* @__PURE__ */ defineComponent({
  __name: "VPNavBarExtra",
  setup(__props) {
    const { site, theme: theme2 } = useData(), hasExtraContent = computed(() => theme2.value.localeLinks || site.value.appearance || theme2.value.socialLinks);
...
const VPNavBarExtra = /* @__PURE__ */ _export_sfc(_sfc_main$F, [["__scopeId", "data-v-e4361c82"]]), _withScopeId$8 = (n) => (pushScopeId("data-v-e5dd9c1c"), n = n(), popScopeId(), n), _hoisted_1$w = ["aria-expanded"], _hoisted_2$o = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("span", { class: "container" }, [
...
const VPNavBarHamburger = /* @__PURE__ */ _export_sfc(_sfc_main$E, [["__scopeId", "data-v-e5dd9c1c"]]), _hoisted_1$v = { class: "container" }, _hoisted_2$n = { class: "content" }, _sfc_main$D = /* @__PURE__ */ defineComponent({
  __name: "VPNavBar",
  props: {
...
const VPNavBar = /* @__PURE__ */ _export_sfc(_sfc_main$D, [["__scopeId", "data-v-1bbed88e"]]);
...
const VPNavScreenMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["__scopeId", "data-v-b7098508"]]), _sfc_main$B = {}, _hoisted_1$u = {
  xmlns: "http://www.w3.org/2000/svg",
  "aria-hidden": "true",
  focusable: "false",
  viewBox: "0 0 24 24"
}, _hoisted_2$m = /* @__PURE__ */ createBaseVNode("path", { d: "M18.9,10.9h-6v-6c0-0.6-0.4-1-1-1s-1,0.4-1,1v6h-6c-0.6,0-1,0.4-1,1s0.4,1,1,1h6v6c0,0.6,0.4,1,1,1s1-0.4,1-1v-6h6c0.6,0,1-0.4,1-1S19.5,10.9,18.9,10.9z" }, null, -1), _hoisted_3$g = [
  _hoisted_2$m
];
function _sfc_render$6(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$u, _hoisted_3$g);
}
const VPIconPlus = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["render", _sfc_render$6]]), _sfc_main$A = /* @__PURE__ */ defineComponent({
...
const VPNavScreenMenuGroupLink = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["__scopeId", "data-v-7f173864"]]), _hoisted_1$t = { class: "VPNavScreenMenuGroupSection" }, _hoisted_2$l = {
  key: 0,
  class: "title"
  ...
  setup(__props) {
    return (_ctx, _cache) => (openBlock(), createElementBlock("div", _hoisted_1$t, [
      __props.text ? (openBlock(), createElementBlock("p", _hoisted_2$l, toDisplayString(__props.text), 1)) : createCommentVNode("", !0),
...
const VPNavScreenMenuGroupSection = /* @__PURE__ */ _export_sfc(_sfc_main$z, [["__scopeId", "data-v-7478538b"]]), _hoisted_1$s = ["aria-controls", "aria-expanded"], _hoisted_2$k = { class: "button-text" }, _hoisted_3$f = ["id"], _hoisted_4$b = {
  key: 1,
  class: "group"
...
const VPNavScreenMenuGroup = /* @__PURE__ */ _export_sfc(_sfc_main$y, [["__scopeId", "data-v-5bc84358"]]), _hoisted_1$r = {
  key: 0,
  ...
  setup(__props) {
    const { theme: theme2 } = useData();
    return (_ctx, _cache) => unref(theme2).nav ? (openBlock(), createElementBlock("nav", _hoisted_1$r, [
      (openBlock(!0), createElementBlock(Fragment, null, renderList(unref(theme2).nav, (item) => (openBlock(), createElementBlock(Fragment, {
        key: item.text
      }, [
...
}), _withScopeId$7 = (n) => (pushScopeId("data-v-7bc19822"), n = n(), popScopeId(), n), _hoisted_1$q = {
  key: 0,
  class: "VPNavScreenAppearance"
}, _hoisted_2$j = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ createBaseVNode("p", { class: "text" }, "Appearance", -1)), _sfc_main$w = /* @__PURE__ */ defineComponent({
  __name: "VPNavScreenAppearance",
  setup(__props) {
    const { site } = useData();
    return (_ctx, _cache) => unref(site).appearance ? (openBlock(), createElementBlock("div", _hoisted_1$q, [
      _hoisted_2$j,
      createVNode(VPSwitchAppearance)
    ])) : createCommentVNode("", !0);
  }
});
const VPNavScreenAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["__scopeId", "data-v-7bc19822"]]), _hoisted_1$p = { class: "list" }, _hoisted_2$i = ["href"], _sfc_main$v = /* @__PURE__ */ defineComponent({
  __name: "VPNavScreenTranslations",
  setup(__props) {
    const { theme: theme2 } = useData(), isOpen = ref(!1);
    function toggle() {
      isOpen.value = !isOpen.value;
    }
    return (_ctx, _cache) => unref(theme2).localeLinks ? (openBlock(), createElementBlock("div", {
      key: 0,
      ...
      createBaseVNode("ul", _hoisted_1$p, [
        (openBlock(!0), createElementBlock(Fragment, null, renderList(unref(theme2).localeLinks.items, (locale) => (openBlock(), createElementBlock("li", {
          key: locale.link,
          class: "item"
        }, [
          createBaseVNode("a", {
...
const VPNavScreenTranslations = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["__scopeId", "data-v-6bfcad30"]]), _sfc_main$u = /* @__PURE__ */ defineComponent({
...
}), _hoisted_1$o = { class: "container" }, _sfc_main$t = /* @__PURE__ */ defineComponent({
  __name: "VPNavScreen",
  props: {
    open: { type: Boolean }
  },
...
const VPNavScreen = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["__scopeId", "data-v-4a289eba"]]), _sfc_main$s = /* @__PURE__ */ defineComponent({
  __name: "VPNav",
  setup(__props) {
    const { isScreenOpen, closeScreen, toggleScreen } = useNav(), { hasSidebar } = useSidebar();
    return provide("close-screen", closeScreen), (_ctx, _cache) => (openBlock(), createElementBlock("header", {
...
const VPIconAlignLeft = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["render", _sfc_render$5]]), _withScopeId$6 = (n) => (pushScopeId("data-v-b6162a8b"), n = n(), popScopeId(), n), _hoisted_1$m = {
  key: 0,
  class: "VPLocalNav"
}, _hoisted_2$g = ["aria-expanded"], _hoisted_3$d = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("span", { class: "menu-text" }, "Menu", -1)), _sfc_main$q = /* @__PURE__ */ defineComponent({
  __name: "VPLocalNav",
  props: {
    open: { type: Boolean }
  },
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => unref(hasSidebar) ? (openBlock(), createElementBlock("div", _hoisted_1$m, [
      createBaseVNode("button", {
        class: "menu",
...
const VPLocalNav = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["__scopeId", "data-v-b6162a8b"]]), _sfc_main$p = {}, _hoisted_1$l = {
  version: "1.1",
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, _hoisted_2$f = /* @__PURE__ */ createBaseVNode("path", { d: "M19,2H5C3.3,2,2,3.3,2,5v14c0,1.7,1.3,3,3,3h14c1.7,0,3-1.3,3-3V5C22,3.3,20.7,2,19,2z M20,19c0,0.6-0.4,1-1,1H5c-0.6,0-1-0.4-1-1V5c0-0.6,0.4-1,1-1h14c0.6,0,1,0.4,1,1V19z" }, null, -1), _hoisted_3$c = /* @__PURE__ */ createBaseVNode("path", { d: "M16,11h-3V8c0-0.6-0.4-1-1-1s-1,0.4-1,1v3H8c-0.6,0-1,0.4-1,1s0.4,1,1,1h3v3c0,0.6,0.4,1,1,1s1-0.4,1-1v-3h3c0.6,0,1-0.4,1-1S16.6,11,16,11z" }, null, -1), _hoisted_4$9 = [
  _hoisted_2$f,
  _hoisted_3$c
];
...
const VPIconPlusSquare = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["render", _sfc_render$4]]), _sfc_main$o = {}, _hoisted_1$k = {
  xmlns: "http://www.w3.org/2000/svg",
  "xmlns:xlink": "http://www.w3.org/1999/xlink",
  viewBox: "0 0 24 24"
}, _hoisted_2$e = /* @__PURE__ */ createBaseVNode("path", { d: "M19,2H5C3.3,2,2,3.3,2,5v14c0,1.7,1.3,3,3,3h14c1.7,0,3-1.3,3-3V5C22,3.3,20.7,2,19,2zM20,19c0,0.6-0.4,1-1,1H5c-0.6,0-1-0.4-1-1V5c0-0.6,0.4-1,1-1h14c0.6,0,1,0.4,1,1V19z" }, null, -1), _hoisted_3$b = /* @__PURE__ */ createBaseVNode("path", { d: "M16,11H8c-0.6,0-1,0.4-1,1s0.4,1,1,1h8c0.6,0,1-0.4,1-1S16.6,11,16,11z" }, null, -1), _hoisted_4$8 = [
  _hoisted_2$e,
  _hoisted_3$b
];
...
const VPIconMinusSquare = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["render", _sfc_render$3]]), _hoisted_1$j = ["innerHTML"], _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props, { page, frontmatter } = useData(), maxDepth = computed(
      () => frontmatter.value.sidebarDepth || 1 / 0
    ), active2 = computed(
      () => isActive(page.value.relativePath, props.item.link)
    ), { isSidebarEnabled } = useSidebar(), closeSideBar = inject("close-sidebar"), isSidebarOpen = inject("is-sidebar-open"), link2 = ref(null);
    return watchEffect(() => {
      var _a2, _b;
      isSidebarOpen.value && active2.value && ((_b = (_a2 = link2.value) == null ? void 0 : _a2.$el) == null || _b.focus());
    }), (_ctx, _cache) => {
      const _component_VPSidebarLink = resolveComponent("VPSidebarLink", !0);
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(VPLink, {
          class: normalizeClass(["link", { active: unref(active2) }]),
          style: normalizeStyle({ paddingLeft: 16 * (__props.depth - 1) + "px" }),
          href: __props.item.link,
          tabindex: unref(isSidebarEnabled) || unref(isSidebarOpen) ? 0 : -1,
          ...
          _: 1
        }, 8, ["class", "style", "href", "tabindex", "onClick"]),
        "items" in __props.item && __props.depth < unref(maxDepth) ? (openBlock(!0), createElementBlock(Fragment, { key: 0 }, renderList(__props.item.items, (child) => (openBlock(), createBlock(_component_VPSidebarLink, {
          key: child.link,
          item: child,
...
const VPSidebarLink = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["__scopeId", "data-v-70e2cdfb"]]), _hoisted_1$i = ["role"], _hoisted_2$d = ["innerHTML"], _hoisted_3$a = { class: "action" }, _hoisted_4$7 = { class: "items" }, _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props, collapsed = ref(!1);
    watchEffect(() => {
      collapsed.value = !!(props.collapsible && props.collapsed);
    });
    const { page } = useData();
    watchEffect(() => {
      props.items.some((item) => isActive(page.value.relativePath, item.link)) && (collapsed.value = !1);
    });
    function toggle() {
      props.collapsible && (collapsed.value = !collapsed.value);
    }
    return (_ctx, _cache) => (openBlock(), createElementBlock("section", {
      ...
      createBaseVNode("div", _hoisted_4$7, [
        (openBlock(!0), createElementBlock(Fragment, null, renderList(__props.items, (item) => (openBlock(), createBlock(VPSidebarLink, {
          key: item.link,
          item
        }, null, 8, ["item"]))), 128))
      ])
...
const VPSidebarGroup = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-6e45c352"]]), _withScopeId$5 = (n) => (pushScopeId("data-v-a186aa16"), n = n(), popScopeId(), n), _hoisted_1$h = {
  class: "nav",
  id: "VPSidebarNav",
  "aria-labelledby": "sidebar-aria-label",
  tabindex: "-1"
}, _hoisted_2$c = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("span", {
  class: "visually-hidden",
  ...
  setup(__props) {
    const props = __props, { sidebar, hasSidebar } = useSidebar();
    let navEl = ref(null);
    function lockBodyScroll() {
    ...
    return watchPostEffect(async () => {
      ...
      createBaseVNode("nav", _hoisted_1$h, [
        ...
        (openBlock(!0), createElementBlock(Fragment, null, renderList(unref(sidebar), (group) => (openBlock(), createElementBlock("div", {
          key: group.text,
          class: "group"
        }, [
...
const VPSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-a186aa16"]]), _sfc_main$k = {}, _hoisted_1$g = { class: "VPPage" };
...
const VPButton = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["__scopeId", "data-v-53dbb8eb"]]), _withScopeId$4 = (n) => (pushScopeId("data-v-1fe9e8f3"), n = n(), popScopeId(), n), _hoisted_1$f = { class: "container" }, _hoisted_2$b = { class: "main" }, _hoisted_3$9 = {
  key: 0,
  class: "name"
...
const VPHero = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-1fe9e8f3"]]), _sfc_main$h = /* @__PURE__ */ defineComponent({
  __name: "VPHomeHero",
  setup(__props) {
...
const VPIconArrowRight = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$1]]), _hoisted_1$d = { class: "box" }, _hoisted_2$9 = {
  key: 1,
  class: "icon"
}, _hoisted_3$7 = { class: "title" }, _hoisted_4$5 = { class: "details" }, _hoisted_5$3 = {
  key: 2,
  class: "link-text"
...
const VPFeature = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-81ce8129"]]), _hoisted_1$c = {
  key: 0,
  class: "VPFeatures"
...
function getHeaders(pageOutline) {
  ...
  return document.querySelectorAll("h2, h3, h4, h5, h6").forEach((el) => {
    el.textContent && el.id && updatedHeaders.push({
...
const VPDocAsideOutlineItem = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-1188541a"]]), _withScopeId$3 = (n) => (pushScopeId("data-v-2865c0b0"), n = n(), popScopeId(), n), _hoisted_1$9 = { class: "content" }, _hoisted_2$7 = { class: "outline-title" }, _hoisted_3$5 = { "aria-labelledby": "doc-outline-aria-label" }, _hoisted_4$4 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ createBaseVNode("span", {
  class: "visually-hidden",
...
const VPDocAsideOutline = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-2865c0b0"]]), _hoisted_1$8 = { class: "VPDocAsideCarbonAds" }, _sfc_main$9 = /* @__PURE__ */ defineComponent({
...
}), _withScopeId$2 = (n) => (pushScopeId("data-v-afc4c1a1"), n = n(), popScopeId(), n), _hoisted_1$7 = { class: "VPDocAside" }, _hoisted_2$6 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ createBaseVNode("div", { class: "spacer" }, null, -1)), _sfc_main$8 = /* @__PURE__ */ defineComponent({
  __name: "VPDocAside",
  setup(__props) {
    const { theme: theme2 } = useData();
    return (_ctx, _cache) => (openBlock(), createElementBlock("div", _hoisted_1$7, [
      ...
      unref(theme2).carbonAds ? (openBlock(), createBlock(_sfc_main$9, { key: 0 })) : createCommentVNode("", !0),
...
const VPDocFooterLastUpdated = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-18fe8fc2"]]), _hoisted_1$4 = {
  key: 0,
  class: "VPDocFooter"
}, _hoisted_2$3 = {
  key: 0,
...
const VPDocFooter = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-21f75714"]]), _withScopeId$1 = (n) => (pushScopeId("data-v-cfb513e0"), n = n(), popScopeId(), n), _hoisted_1$3 = { class: "container" }, _hoisted_2$2 = {
  key: 0,
  class: "aside"
...
const VPDoc = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-cfb513e0"]]), _sfc_main$3 = /* @__PURE__ */ defineComponent({
  __name: "VPContent",
  setup(__props) {
...
const VPContent = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-296cfad2"]]), _hoisted_1$2 = { class: "container" }, _hoisted_2$1 = ["innerHTML"], _hoisted_3$1 = ["innerHTML"], _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "VPFooter",
  setup(__props) {
...
const VPFooter = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-9f24cc86"]]), _hoisted_1$1 = {
  key: 0,
  class: "Layout"
  ...
  const observeLinks = () => {
    observer && observer.disconnect(), observer = new IntersectionObserver((entries) => {
      ...
      document.querySelectorAll("#app a").forEach((link2) => {
        const { target, hostname, pathname } = link2, extMatch = pathname.match(/\.\w+$/);
        extMatch && extMatch[0] !== ".html" || target !== "_blank" && hostname === location.hostname && (pathname !== location.pathname ? observer.observe(link2) : hasFetched.add(pathname));
      });
    });
  };
...
function useCodeGroups() {
  inBrowser$1 && window.addEventListener("click", (e) => {
    var _a2, _b;
    const el = e.target;
...
function newRouter() {
  let isInitialPageLoad = inBrowser$1, initialPath;
  return createRouter((path) => {
    let pageFilePath = pathToFile(path);
    return isInitialPageLoad && (initialPath = pageFilePath), (isInitialPageLoad || initialPath === pageFilePath) && (pageFilePath = pageFilePath.replace(/\.js$/, ".lean.js")), inBrowser$1 && (isInitialPageLoad = !1), __vitePreload(() => import(pageFilePath), []);
  }, NotFound);
}
if (inBrowser$1) {
