function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/chunks/VPLocalSearchBox.BM3GlpJ4.js","assets/chunks/framework.CL6Y9brc.js"]
  }
...
const _hoisted_1$d = ["aria-label"], _hoisted_2$a = { class: "DocSearch-Button-Container" }, _hoisted_3$7 = /* @__PURE__ */ createBaseVNode("span", { class: "vp-icon DocSearch-Search-Icon" }, null, -1), _hoisted_4$3 = { class: "DocSearch-Button-Placeholder" }, _hoisted_5$3 = /* @__PURE__ */ createBaseVNode("span", { class: "DocSearch-Button-Keys" }, [
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.BM3GlpJ4.js"), __vite__mapDeps([0,1]))), VPAlgoliaSearchBox = () => null, { theme: theme2 } = useData(), loaded = ref(!1), actuallyLoaded = ref(!1);
    onMounted(() => {
    });
    function load() {
