...
| $global | Object which allows storing global Variables | | [globalVariables.http](https://github.com/httpyac/httpyac.github.io/blob/main/examples/variables/globalVariables.http) |
